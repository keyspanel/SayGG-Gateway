      ...
      <form onSubmit={submit} className="gw-auth-card">
        <div className="gw-auth-brand">
          ...
          <div>
            ...
            <p>Spin up your own UPI payment gateway in minutes</p>
          </div>
        </div>
        ...
        <label className="gw-field">
          <span>Username <small>3–32 chars · letters, digits, _</small></span>
        ...
        <div className="gw-auth-foot">
          Already a merchant? <Link to="/gateway/login">Sign in</Link>
        </div>
      </form>
    </div>
  );
