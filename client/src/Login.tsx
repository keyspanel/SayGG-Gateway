    ...
    <div className="gw-auth-page">
      <form onSubmit={submit} className="gw-auth-card">
        <div className="gw-auth-brand">
          ...
          <div>
            <h1>Welcome back</h1>
            <p>Sign in to your payment gateway console</p>
          </div>
        </div>
        ...
        <label className="gw-field">
          ...
          <input value={u} onChange={(e) => setU(e.target.value)} required autoFocus autoComplete="username" placeholder="merchant or you@example.com" inputMode="email" />
        </label>
        ...
        <div className="gw-auth-foot">
          New here? <Link to="/gateway/register">Create an account</Link>
        </div>
      </form>
    </div>
  );
